...
String[] mainSections = new String[]{"details"};

if (permissionChecker.isOmniadmin())
	mainSections = ArrayUtil.append(mainSections,new String[]{"details","look-and-feel","javascript","custom-fields","advanced","mobile-device-rules"});
