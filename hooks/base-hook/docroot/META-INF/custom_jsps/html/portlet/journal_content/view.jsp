...
boolean isPortfolioPage = PortfolioLocalServiceUtil.fetchPortfolio(layout.getPlid()) != null;
%>
...
<c:if test="<%= showIconsActions && !print && hasViewPermission %>">
	<div class="lfr-meta-actions icons-container">
		<div class="lfr-icon-actions">
			...
			<c:if test="<%= showSelectArticleIcon && !isPortfolioPage%>">
				<liferay-ui:icon
