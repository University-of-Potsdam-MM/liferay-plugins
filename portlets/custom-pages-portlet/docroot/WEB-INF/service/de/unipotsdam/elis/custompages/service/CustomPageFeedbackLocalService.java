...
/**
 * Provides the local service interface for CustomPageFeedback. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matthias
 * @see CustomPageFeedbackLocalServiceUtil
...
public interface CustomPageFeedbackLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomPageFeedbackLocalServiceUtil} to access the custom page feedback local service. Add custom service methods to {@link de.unipotsdam.elis.custompages.service.impl.CustomPageFeedbackLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
