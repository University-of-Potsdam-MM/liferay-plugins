...
public class OtherCustomPagesNotificationHandler extends BaseUserNotificationHandler {
	
	public static String PORTLET_ID = "othercustompages_WAR_custompagesportlet";

	public OtherCustomPagesNotificationHandler() {
