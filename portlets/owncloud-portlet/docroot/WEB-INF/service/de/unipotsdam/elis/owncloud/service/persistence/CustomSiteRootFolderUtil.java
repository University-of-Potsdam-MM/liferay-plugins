...
/**
 * The persistence utility for the custom site root folder service. This utility wraps {@link CustomSiteRootFolderPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class CustomSiteRootFolderUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(CustomSiteRootFolder customSiteRootFolder) {
		getPersistence().clearCache(customSiteRootFolder);
	}
	 ...
	 */
	public static List<CustomSiteRootFolder> findWithDynamicQuery(
	 ...
	 */
	public static CustomSiteRootFolder update(
		CustomSiteRootFolder customSiteRootFolder) throws SystemException {
		return getPersistence().update(customSiteRootFolder);
	}
	 ...
	 */
	public static CustomSiteRootFolder update(
		CustomSiteRootFolder customSiteRootFolder, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(customSiteRootFolder, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(customSiteRootFolder);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(customSiteRootFolders);
	}
	...
	*/
	public static de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder create(
		CustomSiteRootFolderPK customSiteRootFolderPK) {
		return getPersistence().create(customSiteRootFolderPK);
	}
	...
	*/
	public static de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder remove(
		CustomSiteRootFolderPK customSiteRootFolderPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			de.unipotsdam.elis.owncloud.NoSuchCustomSiteRootFolderException {
		return getPersistence().remove(customSiteRootFolderPK);
	}

	public static de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder updateImpl(
		de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder customSiteRootFolder)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(customSiteRootFolder);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder findByPrimaryKey(
		CustomSiteRootFolderPK customSiteRootFolderPK)
		throws com.liferay.portal.kernel.exception.SystemException,
			de.unipotsdam.elis.owncloud.NoSuchCustomSiteRootFolderException {
		return getPersistence().findByPrimaryKey(customSiteRootFolderPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder fetchByPrimaryKey(
		CustomSiteRootFolderPK customSiteRootFolderPK)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(customSiteRootFolderPK);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<de.unipotsdam.elis.owncloud.model.CustomSiteRootFolder> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CustomSiteRootFolderPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CustomSiteRootFolderPersistence)PortletBeanLocatorUtil.locate(de.unipotsdam.elis.owncloud.service.ClpSerializer.getServletContextName(),
					CustomSiteRootFolderPersistence.class.getName());

			ReferenceRegistry.registerReference(CustomSiteRootFolderUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CustomSiteRootFolderPersistence persistence) {
	}

	private static CustomSiteRootFolderPersistence _persistence;
}