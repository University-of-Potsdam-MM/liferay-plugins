...
/**
 * Provides the local service interface for CustomSiteRootFolder. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matthias
 * @see CustomSiteRootFolderLocalServiceUtil
...
public interface CustomSiteRootFolderLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomSiteRootFolderLocalServiceUtil} to access the custom site root folder local service. Add custom service methods to {@link de.unipotsdam.elis.owncloud.service.impl.CustomSiteRootFolderLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
