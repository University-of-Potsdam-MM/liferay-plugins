...
<form id="workspaceColorForm" action="<%= saveColorsURL %>" method="post" name="fm">
	...
	<div class="visibleWorkspaceCount">
		<label for="number-of-visible-workspaces"><%= LanguageUtil.get(pageContext, "number-of-visible-workspaces")%></label>
		<input id="number-of-visible-workspaces" name="<portlet:namespace /><%= WorkspaceGridPortlet.NUMBER_OF_VISIBLE_WORKSPACES %>" value="<%= visibleWorkspaces %>"></input>
	</div>
