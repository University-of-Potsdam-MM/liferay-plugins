...
/**
 * Provides the local service interface for MoodleSocialActivity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matthias
 * @see MoodleSocialActivityLocalServiceUtil
...
public interface MoodleSocialActivityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MoodleSocialActivityLocalServiceUtil} to access the moodle social activity local service. Add custom service methods to {@link de.unipotsdam.elis.activities.service.impl.MoodleSocialActivityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
