 ...
 * @generated
 */
public class MoodleSocialActivityLocalServiceClp
	implements MoodleSocialActivityLocalService {
	public MoodleSocialActivityLocalServiceClp(
		...
		_methodName19 = "getMostRecentMoodleSocialActivity";

		_methodParameterTypes19 = new String[] { "long" };

		_methodName20 = "addMoodleSocialActivity";
	...
	public de.unipotsdam.elis.activities.model.MoodleSocialActivity addMoodleSocialActivity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(moodleSocialActivity)
					});
		}
		catch (Throwable t) {
		...
		return (de.unipotsdam.elis.activities.model.MoodleSocialActivity)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.unipotsdam.elis.activities.model.MoodleSocialActivity createMoodleSocialActivity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { extSocialActivityId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.unipotsdam.elis.activities.model.MoodleSocialActivity deleteMoodleSocialActivity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { extSocialActivityId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public de.unipotsdam.elis.activities.model.MoodleSocialActivity fetchMoodleSocialActivity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					...
					new Object[] { extSocialActivityId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<de.unipotsdam.elis.activities.model.MoodleSocialActivity> getMoodleSocialActivities(
		...
		return (java.util.List<de.unipotsdam.elis.activities.model.MoodleSocialActivity>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public de.unipotsdam.elis.activities.model.MoodleSocialActivity addMoodleSocialActivity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					ClpSerializer.translateInput(extServiceActivityType),
						
					ClpSerializer.translateInput(extServiceContext),
