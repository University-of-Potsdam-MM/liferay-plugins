...
public class MoodleDataBaseActivityInterpreter extends
	...
	protected String getTitlePattern(SocialActivitySet activitySet,
		...
		if ("ma:record".equals(moodleSocialActivityType))
			return "added-new-database-record";
		else
			return "added-new-database-field";
	}
}
