...
/**
 * Provides the base implementation for the ext social activity set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.unipotsdam.elis.activities.service.impl.ExtSocialActivitySetLocalServiceImpl}.
 * </p>
 *
 * @author Matthias
 ...
 * @generated
 */
public abstract class ExtSocialActivitySetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ExtSocialActivitySetLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link de.unipotsdam.elis.activities.service.ExtSocialActivitySetLocalServiceUtil} to access the ext social activity set local service.
	 */
	...
	private ExtSocialActivitySetLocalServiceClpInvoker _clpInvoker = new ExtSocialActivitySetLocalServiceClpInvoker();
}