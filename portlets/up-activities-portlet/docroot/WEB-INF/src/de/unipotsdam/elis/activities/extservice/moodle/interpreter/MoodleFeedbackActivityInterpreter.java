...
public class MoodleFeedbackActivityInterpreter extends
...
//		return StringPool.BLANK;
		...
		if (moodleSocialActivityType.equalsIgnoreCase("created")) {
			// TODO change message if submitted, created, or updated
		}
		
		return LanguageUtil.get(portletConfig, serviceContext.getLocale(), "added-new-feedback");
	}
