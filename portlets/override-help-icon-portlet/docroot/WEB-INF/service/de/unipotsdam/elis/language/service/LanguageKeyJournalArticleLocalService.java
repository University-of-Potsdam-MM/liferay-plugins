...
/**
 * Provides the local service interface for LanguageKeyJournalArticle. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matthias
 * @see LanguageKeyJournalArticleLocalServiceUtil
...
public interface LanguageKeyJournalArticleLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LanguageKeyJournalArticleLocalServiceUtil} to access the language key journal article local service. Add custom service methods to {@link de.unipotsdam.elis.language.service.impl.LanguageKeyJournalArticleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
