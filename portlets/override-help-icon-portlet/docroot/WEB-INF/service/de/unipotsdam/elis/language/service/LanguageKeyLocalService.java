...
/**
 * Provides the local service interface for LanguageKey. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Matthias
 * @see LanguageKeyLocalServiceUtil
...
public interface LanguageKeyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LanguageKeyLocalServiceUtil} to access the language key local service. Add custom service methods to {@link de.unipotsdam.elis.language.service.impl.LanguageKeyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
