...
boolean enableOpenSites = GetterUtil.getBoolean(portletPreferences.getValue("enableOpenSites", null), false);
boolean enablePublicRestrictedSites = GetterUtil.getBoolean(portletPreferences.getValue("enablePublicRestrictedSites", null), false);
