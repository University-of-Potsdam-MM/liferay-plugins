...
<form action="<%= portletURL.toString() %>" method="get" name="<portlet:namespace />fm">
	...
	<div class="search">
		<input class="search-input" id="<portlet:namespace />name" name="<portlet:namespace />name" placeholder="<liferay-ui:message key="filter" />" size="30" type="text" value="<%= HtmlUtil.escape(name) %>" />
