...
<liferay-ui:icon-menu>
	...
	<portlet:actionURL name="deletePortfolio" var="deletePortfolioURL">
		<portlet:param name="plid" value="<%=String.valueOf(portfolioPlid)%>" />
		<portlet:param name="redirect" value="<%=redirect%>" />
	</portlet:actionURL>

	<liferay-ui:icon-delete url="<%=deletePortfolioURL.toString()%>" />
	
	<liferay-ui:icon image="edit" url="<%=JspHelper.getPortfolioURL(themeDisplay, portfolio, themeDisplay.getUser())%>" ></liferay-ui:icon>
</liferay-ui:icon-menu>