...
public class OtherPortfoliosNotificationHandler extends BaseUserNotificationHandler {
	
	public static String PORTLET_ID = "otherportfolios_WAR_portfolioportlet";

	public OtherPortfoliosNotificationHandler() {
